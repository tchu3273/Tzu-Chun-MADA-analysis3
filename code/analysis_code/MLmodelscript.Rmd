...
# Fit model to training data
best_lasso_train_fit <- final_lasso %>%  fit(data = train_data)
```
...
# Fit model to training data
best_rf_train_fit <- final_rf %>%  fit(data = train_data)
